...
public class DataTv implements Parcelable {
    ...
    public DataTv(int id, String judul, String popularity, String tanggal, String overview, String photo, String rating, String language, String URL) {
        this.id = id;
        this.judul = judul;
    ...
    public DataTv(JSONObject object) {
        try {
            int id = object.getInt("id");
            String original_title = object.getString("original_name");
